package me.smecsia.test.kundera.util;
...
import static me.smecsia.test.kundera.util.DateUtil.*;
...
public class UUIDUtil {
    ...
    public static UUID uuidForDate(Date d) {
        return new UUID(createTime(d.getTime()), UUIDGen.getClockSeqAndNode());
    }
